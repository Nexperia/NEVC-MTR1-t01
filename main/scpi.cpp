...
static void ScpiCoreIdnQ(SCPI_C commands, SCPI_P parameters, Stream &interface)
{
    ...
    interface.print(F(","));
    interface.print((unsigned long)MOTOR_POLES, HEX);
    interface.print('-');
    interface.print((unsigned long)F_MOSFET, HEX);
    interface.print('-');
    interface.print((unsigned long)DEAD_TIME, HEX);
    interface.print('-');
    interface.print((unsigned long)EMULATE_HALL, HEX);
    interface.print('-');
    interface.print((unsigned long)TIM3_FREQ, HEX);
    interface.print('-');
    interface.print((unsigned long)COMMUTATION_TICKS_STOPPED, HEX);
    interface.print('-');
    interface.print((unsigned long)TURN_OFF_MODE, HEX);
    interface.print('-');
    interface.print((unsigned long)IPHASE_GAIN, HEX);
    interface.print('-');
    interface.print((unsigned long)IPHASE_SENSE_RESISTOR, HEX);
    interface.print('-');
    interface.print((unsigned long)IBUS_GAIN, HEX);
    interface.print('-');
    interface.print((unsigned long)IBUS_SENSE_RESISTOR, HEX);
    interface.print('-');
    interface.print((unsigned long)IBUS_WARNING_THRESHOLD, HEX);
    interface.print('-');
    interface.print((unsigned long)IBUS_ERROR_THRESHOLD, HEX);
    interface.print('-');
    interface.print((unsigned long)IBUS_FAULT_ENABLE, HEX);
    interface.print('-');
    interface.print((unsigned long)SPEED_CONTROL_METHOD, HEX);
    interface.print('-');
    interface.print((unsigned long)SPEED_CONTROLLER_TIME_BASE, HEX);
    interface.print('-');
    interface.print((unsigned long)SPEED_CONTROLLER_MAX_DELTA, HEX);
    interface.print('-');
    interface.print((unsigned long)SPEED_CONTROLLER_MAX_SPEED, HEX);
    interface.print('-');
    interface.print((unsigned long)PID_K_P, HEX);
    interface.print('-');
    interface.print((unsigned long)PID_K_I, HEX);
    interface.print('-');
    interface.print((unsigned long)PID_K_D_ENABLE, HEX);
    interface.print('-');
    interface.print((unsigned long)PID_K_D, HEX);
    interface.print('-');
    interface.print((unsigned long)VBUS_RTOP, HEX);
    interface.print('-');
    interface.print((unsigned long)VBUS_RBOTTOM, HEX);
    interface.print('-');
